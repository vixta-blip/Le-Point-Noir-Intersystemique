...
Le site ne contient ni musique de fond ni interrupteur sonore. Après le premier geste du visiteur — conformément aux règles des navigateurs — des micro-sons synthétisés localement accompagnent uniquement les commandes utiles. Le livre, l’image des pages et les numéros de pagination restent silencieux. En lecture opérative, le survol ou le toucher d’un terme déclenche aléatoirement l’un de dix gestes de surligneur, visuels et sonores. Aucune information ne dépend du son.

Le contact s’ouvre dans une interface intégrée. Le formulaire est transmis par l’endpoint AJAX de FormSubmit vers `sekaii.philo@gmail.com`, sans ouvrir Gmail ni la messagerie du navigateur. Après la première mise en ligne, effectuer un envoi d’essai puis valider une seule fois le courriel d’activation reçu à cette adresse. Sans cette activation, FormSubmit ne remet pas les messages suivants.
